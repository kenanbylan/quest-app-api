...
import com.springproject.QuestApp.repositorys.CommentRepository;
...
public class CommentService {
    ...
    public List<Comment> getAllCommentWithParam(Optional<Long> userId, Optional<Long> postId) {
        ...
        if(userId.isPresent()  && postId.isPresent()) {
            return  commentRepository.findAllByIdAndPostId(userId.get() ,postId.get());
    ...
    public Comment createOneComment(CommentCreateRequest request) {
        ...
        if (user != null && post!= null) {
            Comment toCommentSave = new Comment();

            toCommentSave.setId(request.getId());
            toCommentSave.setPost(post);
            toCommentSave.setUser(user);
            toCommentSave.setText(request.getText());

            return commentRepository.save(toCommentSave);
        } else {
            return  null;
        }
